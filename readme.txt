...
This branch in particular is a disassembly of the Mega Play arcade version of Sonic 2.
...
Non-Windows users will also need to install GCC's C++ compiler ("g++"), as the rest of the build tools are compiled from source when build.sh is first ran.
